...
class Add_Service:
    ...
    def create_interface(self):
        ...
        self.titleLabel = Label(self.titleFrame, text="Agregar servicio: ", font='Kameron 50', background="#c9bbd2")
        ...
        self.endRegBtn = Button(self.btnFrame, text="Terminar registro", font=('Inter Medium', 10), background="#c9bbd2",
