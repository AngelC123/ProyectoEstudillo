...
class Agregar_Vehiculo:
    ...
    def create_interface(self):
        ...
        self.titleLabel = Label(self.titleFrame, text="Agregar vehículo", font='Kameron 50', background="#c9bbd2")
        ...
        self.yearEntry = Entry(self.infoFrame, font=('Inter Medium', 11), width=75)
        ...
        self.addVehBtn = Button(self.btnFrame, text="Agregar vehículo", font='Kameron 15', width=15, pady=2,
                                borderwidth=0,
