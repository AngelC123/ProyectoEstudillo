...
class Modificar_Cliente:
    ...
    def create_interface(self):
        ...
        self.titleLabel=Label(self.titleFrame, text="Modificar cliente", background="#c9bbd2", font='Kameron 50')
        ...
        self.addBtn = Button(self.btnFrame, text="Modificar", font='Kameron 15', borderwidth=0, width=10, pady=2,
